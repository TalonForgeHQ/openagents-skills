...
description: Weekly retro for the openclaw CLI variant.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Weekly retro for the openclaw CLI variant.

This skill is a vendor-neutral port of
[garrytan/gstack/gstack-openclaw-retro](https://github.com/garrytan/gstack/tree/main/gstack-openclaw-retro)
