---
name: devex-review
description: DX review of a flow — measure time-to-hello-world, find friction.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
DX review of a flow — measure time-to-hello-world, find friction.

This skill is a vendor-neutral port of
[garrytan/gstack/devex-review](https://github.com/garrytan/gstack/tree/main/devex-review)
