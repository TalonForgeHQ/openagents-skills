---
name: plan-tune
description: Self-tune question sensitivity per topic.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Self-tune question sensitivity per topic.

This skill is a vendor-neutral port of
[garrytan/gstack/plan-tune](https://github.com/garrytan/gstack/tree/main/plan-tune)
