---
name: learn
description: Review, search, prune, export project learnings.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Review, search, prune, export project learnings.

This skill is a vendor-neutral port of
[garrytan/gstack/learn](https://github.com/garrytan/gstack/tree/main/learn)
