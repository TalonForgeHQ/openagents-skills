...
description: Merge a PR, wait for CI, verify production health.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Merge a PR, wait for CI, verify production health.

This skill is a vendor-neutral port of
[garrytan/gstack/land-and-deploy](https://github.com/garrytan/gstack/tree/main/land-and-deploy)
