---
name: context-save
description: Save working context to a file for later resume.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Save working context to a file for later resume.

This skill is a vendor-neutral port of
[garrytan/gstack/context-save](https://github.com/garrytan/gstack/tree/main/context-save)
