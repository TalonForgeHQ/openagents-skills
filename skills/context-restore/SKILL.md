...
description: Resume a saved working context (git state, decisions, remaining work).
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Resume a saved working context (git state, decisions, remaining work).

This skill is a vendor-neutral port of
[garrytan/gstack/context-restore](https://github.com/garrytan/gstack/tree/main/context-restore)
