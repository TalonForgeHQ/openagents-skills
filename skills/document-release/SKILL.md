...
description: Post-ship documentation update — sync docs to what shipped.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Post-ship documentation update — sync docs to what shipped.

This skill is a vendor-neutral port of
[garrytan/gstack/document-release](https://github.com/garrytan/gstack/tree/main/document-release)
