---
name: skillify
description: Codify the most recent successful scrape into a permanent browser-skill.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Codify the most recent successful scrape into a permanent browser-skill.

This skill is a vendor-neutral port of
[garrytan/gstack/skillify](https://github.com/garrytan/gstack/tree/main/skillify)
