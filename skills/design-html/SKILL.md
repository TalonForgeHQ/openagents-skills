---
name: design-html
description: Generate production-quality HTML/CSS from a brief.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Generate production-quality HTML/CSS from a brief.

This skill is a vendor-neutral port of
[garrytan/gstack/design-html](https://github.com/garrytan/gstack/tree/main/design-html)
