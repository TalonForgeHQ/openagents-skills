---
name: landing-report
description: Read-only dashboard showing what's in the ship queue.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Read-only dashboard showing what's in the ship queue.

This skill is a vendor-neutral port of
[garrytan/gstack/landing-report](https://github.com/garrytan/gstack/tree/main/landing-report)
