---
name: canary
description: Post-deploy canary monitoring — watch the live app for errors.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Post-deploy canary monitoring — watch the live app for errors.

This skill is a vendor-neutral port of
[garrytan/gstack/canary](https://github.com/garrytan/gstack/tree/main/canary)
