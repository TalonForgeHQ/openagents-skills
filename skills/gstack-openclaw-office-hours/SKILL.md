...
description: Office hours for the openclaw CLI variant.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Office hours for the openclaw CLI variant.

This skill is a vendor-neutral port of
[garrytan/gstack/gstack-openclaw-office-hours](https://github.com/garrytan/gstack/tree/main/gstack-openclaw-office-hours)
