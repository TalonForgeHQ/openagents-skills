---
name: diagram
description: Generate diagrams from code or text descriptions.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Generate diagrams from code or text descriptions.

This skill is a vendor-neutral port of
[garrytan/gstack/diagram](https://github.com/garrytan/gstack/tree/main/diagram)
