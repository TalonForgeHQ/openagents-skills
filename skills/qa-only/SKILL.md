---
name: qa-only
description: QA methodology that produces a report only — no code changes.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
QA methodology that produces a report only — no code changes.

This skill is a vendor-neutral port of
[garrytan/gstack/qa-only](https://github.com/garrytan/gstack/tree/main/qa-only)
