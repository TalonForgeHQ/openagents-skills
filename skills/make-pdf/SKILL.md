---
name: make-pdf
description: Turn markdown into a publication-quality PDF.
version: 1.0.0
allowed-tools:
  - bash
  - read
...
Turn markdown into a publication-quality PDF.

This skill is a vendor-neutral port of
[garrytan/gstack/make-pdf](https://github.com/garrytan/gstack/tree/main/make-pdf)
